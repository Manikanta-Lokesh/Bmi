...
def signin() :
    ...
    file=open('python_pratice/Python_App/Main_Login_Page/datasheet.txt','r')
    d=file.read()
...
def signup_command() :
    ...
    img = Image.open('python_pratice/Python_App/Main_Login_Page/SignUp_img.jpeg')
    ...
    def signup():
        ...
        if(password==conform_password):
            try:
                ...
                file=open('python_pratice/Python_App/Main_Login_Page/datasheet.txt','w')
                w=file.write(str(r))
...
img = Image.open('python_pratice/Python_App/Main_Login_Page/login.jpg')
